...
def set_plane_pos(cl, m):
  p = cl.simGetObjectPose(m).position
  plane_pos[m] = (p.y_val, p.x_val) #ned
...
def loop():
  ...
  if to_plot:
    ...
    for b in borders:
      points=[Vector3r(b[1], b[0], 0), Vector3r(b[3], b[2], 0)] #ned
